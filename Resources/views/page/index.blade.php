        ...
        <div class="tbl-row">
            ...
            <div class="tbl-cell tbl-cell-action-bordered">
                <a href="{{ route('admin.pages.create') }}"
                   ...
                   data-original-title="{{ \Translate::get('module_pages::admin/main.form.page_title_create') }}" class="action-btn">
            ...
            <div class="tbl-cell tbl-cell-action-bordered">
                <button type="button" data-token="{!! csrf_token() !!}" data-inputs=".delete-item-check:checked"
                        ...
                        data-text="{{ \Translate::get('module_pages::admin/main.list.action_delete_confirm') }}" data-action="{{ route('admin.pages.delete.all') }}" class="action-btn delete-all">
