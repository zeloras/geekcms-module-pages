...
@section('title',  Translate::get('module_pages::admin/main.list.block.action_index_create') )
        ...
        <header class="box-typical-header">
            <div class="tbl-row">
                <div class="tbl-cell tbl-cell-title border-bottom">
                    <h3>{{ Translate::get('module_pages::admin/main.list.block.action_index_create') }}</h3>
                </div>
            </div>
        </header>
        <header class="box-typical-header">
            <div class="tbl-row">
                <div class="tbl-cell tbl-cell-title">
                    <ul class="nav nav-tabs" id="blockControlTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="variable-tab" data-toggle="tab" href="#variable" role="tab"
                               aria-controls="variable" aria-selected="false">
